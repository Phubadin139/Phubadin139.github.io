...
SELECT TOP 5
  ...
  CAST(SUM(od.Quantity * od.UnitPrice * (1.0 - od.Discount)) AS DECIMAL(18,4)) AS TotalSales
FROM Employees e
...
SELECT
  ...
  sh.Phone,
  COUNT(o.OrderID) AS NumberOfOrdersTo_USA_Canada,
...
ORDER BY NumberOfOrdersTo_USA_Canada DESC;
